...
const SideBar = () => {
    ...
    return (
        <div className="  font-mono w-[260px] text-[#ECECEC] flex flex-col h-full ">
            <div className=' px-5 h-14 text-[#ECECEC] flex justify-between items-center'>
                <div>
            ...
            <div className='px-3   overflow-y-auto flex-1'>
                ...
                <div className=' cursor-pointer  '>
                    <Link href="/upload" className=' no-underline text-[#ECECEC] flex items-center py-2 px-3  text-sm  gap-2 hover:bg-[#212121] rounded-lg '>
                        ...
                        <p className=' text-[16px]  ml-1'> Explore RAG</p>

                    </Link>
                    <div className='  font font-light pl-3 my-4'>Recent </div>
                    <div className=' flex items-center py-2 px-3  text-sm  gap-2 hover:bg-[#212121] rounded-lg '>
                        <IoChatboxOutline className="text-white" />
                        <p className=' text-[16px]  ml-1'> Conversation 1</p>
                    </div>
                    <div className=' flex items-center py-2 px-3  text-sm  gap-2 hover:bg-[#212121] rounded-lg '>
                        <IoChatboxOutline className="text-white" />
                        <p className=' text-[16px]  ml-1'> Conversation 2</p>
                    </div>
                    <div className=' flex items-center py-2 px-3  text-sm  gap-2 hover:bg-[#212121] rounded-lg '>
                        <IoChatboxOutline className="text-white" />
                        <p className=' text-[16px]  ml-1'> Conversation 3</p>
                    </div>
                    <div className=' flex items-center py-2 px-3  text-sm  gap-2 hover:bg-[#212121] rounded-lg '>
                        <IoChatboxOutline className="text-white" />
                        <p className=' text-[16px]  ml-1'> Conversation 4</p>
                    </div>

                    <div className=' flex items-center py-2 px-3  text-sm  gap-2 hover:bg-[#212121] rounded-lg '>
                        <IoChatboxOutline className="text-white" />
                        <p className=' text-[16px]  ml-1'> Conversation 5</p>
                    </div>
            ...
            <div className=' cursor-pointer px-3 h-[84px]'>
                <div className='flex items-center gap-2 py-2  hover:bg-[#212121] rounded-lg'>
                    ...
                    <div className=' ml-1'>
                        <p className='  text-[16px]'>Upgrade plan</p>
                        <p className=' font-sans text-[12px] text-gray-500 '> Get GPT-4, DALL-E and more</p>
                    </div>
                </div>
            </div>
